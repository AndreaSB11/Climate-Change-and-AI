...
#Remover las variables que tengan al menos 3% de impureza
...
#let's look at how this response is distributed -> INFORMACIÓN SOBRE LA VARIABLE DE RESPUESTA
...
#So this tree has an error rate of (5+4)/80=0.1125 -> 11% tasa de error 
...
# So this tree has an error rate of (6+3)/80 - Es la misma que en el modelo pasado 
#Tiene más errores en la predicción de los países de altas emisiones
#Intentar nuevos modelos con 6, 3, nodos, etc. 
#Menor tasa de error en países de altas emisones, genera condiciones sociodemográficas en los países. 
#Cambiar partición de train y test - Ver errores de clasificación y comparar errores. 
#Buscar NDC. 
